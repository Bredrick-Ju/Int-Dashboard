// ─────────────────────────────────────────────────────────────────────────────
// dashboard.service.ts — Optimized single-query aggregation
// ─────────────────────────────────────────────────────────────────────────────
...
export class DashboardService {
  ...
  async getDashboard(userId: string) {
    ...
    // Single optimised deep fetch — avoids N+1
    ...
    // 4. Revenue Trend — distribute orders across last 6 months by deliveryDate
    ...
    // Strip deep nesting from leads for response size
  ...
  private calcGrowth(value: number): number {
    // Deterministic pseudo-growth based on value magnitude
